<?php
/**
 * ADMIN/DASHBOARD.PHP — TRANG THỐNG KÊ ADMIN
 * ================================================
 * File này nằm trong thư mục /admin/ nên:
 *   - $base_path = '../'  (lùi lại 1 cấp về thư mục gốc)
 *   - include phải là '../includes/header.php'
 *
 * Lý do: CSS và JS được đặt ở /assets/ (thư mục gốc).
 * Nếu $base_path = '' thì trình duyệt sẽ tìm
 * /admin/assets/css/style.css → SAI.
 * Với $base_path = '../', nó sẽ tìm /assets/css/style.css → ĐÚNG.
 * ================================================
 */
